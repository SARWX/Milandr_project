# 1 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h" 2
# 50 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
...
# 90 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
    BKP_RTC_LSIclk = ((uint32_t)0x0000),
    BKP_RTC_LSEclk = ((uint32_t)0x0004),
    BKP_RTC_HSIclk = ((uint32_t)0x0008),
    BKP_RTC_HSEclk = ((uint32_t)0x000C)
} BKP_RTC_CLK;
# 106 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
    BKP_RTC_IT_ALRF = ((uint32_t)((uint32_t)0x00000020)),
    BKP_RTC_IT_SECF = ((uint32_t)((uint32_t)0x00000010)),
    BKP_RTC_IT_OWF = ((uint32_t)((uint32_t)0x00000008) )
} BKP_RTC_IT;
...
typedef enum
{
    BKP_RTC_FLAG_WEC = ((uint32_t)((uint32_t)0x00000040) ),
    BKP_RTC_FLAG_OWF = ((uint32_t)((uint32_t)0x00000001) ),
    BKP_RTC_FLAG_ALRF = ((uint32_t)((uint32_t)0x00000004)),
    BKP_RTC_FLAG_SECF = ((uint32_t)((uint32_t)0x00000002))
} BKP_RTC_FLAGS;
# 141 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
    BKP_DUcc_upto_10MHz = ((uint32_t)((0) | (0 << 3))),
    BKP_DUcc_upto_200kHz = ((uint32_t)((1) | (1 << 3))),
    BKP_DUcc_upto_500kHz = ((uint32_t)((2) | (2 << 3))),
    BKP_DUcc_upto_1MHz = ((uint32_t)((3) | (3 << 3))),
    BKP_DUcc_clk_off = ((uint32_t)((4) | (4 << 3))),
    BKP_DUcc_upto_40MHz = ((uint32_t)((5) | (5 << 3))),
    BKP_DUcc_upto_80MHz = ((uint32_t)((6) | (6 << 3))),
    BKP_DUcc_over_80MHz = ((uint32_t)((7) | (7 << 3)))
} BKP_DUcc_Mode;
# 165 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
    BKP_DUcc_plus_100mV = ((uint32_t)(0x0000 << 8)),
    BKP_DUcc_plus_060mV = ((uint32_t)(0x0001 << 8)),
    BKP_DUcc_plus_040mV = ((uint32_t)(0x0002 << 8)),
    BKP_DUcc_plus_010mV = ((uint32_t)(0x0003 << 8)),
    BKP_DUcc_minus_010mV = ((uint32_t)(0x0004 << 8)),
    BKP_DUcc_minus_040mV = ((uint32_t)(0x0005 << 8)),
    BKP_DUcc_minus_060mV = ((uint32_t)(0x0006 << 8)),
    BKP_DUcc_minus_100mV = ((uint32_t)(0x0007 << 8))
} BKP_DUcc_Trim;
# 206 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
typedef enum
{
    BKP_STOPentry_WFE = ((uint32_t)0x00),
    BKP_STOPentry_WFI = ((uint32_t)0x01)
} BKP_Stop_Entry_Mode;
# 241 "./SPL/MDR32Fx/inc\\MDR32F9Qx_bkp.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c" 2
# 80 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
void BKP_DeInit(void)
{
    ...
    ((MDR_BKP_TypeDef *) (0x400D8000))->REG_0F = (uint32_t) (((uint32_t)0x00008000) | ((uint32_t)0x00400000));
}
# 113 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
void BKP_JTAGA_CMD(FunctionalState NewState)
{
...
# 129 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
void BKP_JTAGB_CMD(FunctionalState NewState)
{
...
void BKP_RTCclkSource(BKP_RTC_CLK RTC_CLK)
{
    ...
    tmpreg |= ((uint32_t)0x0000000C) & (uint32_t)RTC_CLK;
...
# 178 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
}
...
# 225 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
}
...
void BKP_RTC_ITConfig(BKP_RTC_IT BKP_RTC_IT_Source, FunctionalState NewState)
{
    ...
    if (NewState != DISABLE)
    {
        ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS |= (uint32_t)BKP_RTC_IT_Source;
    }
    else
    {
        ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS &= (uint32_t)~BKP_RTC_IT_Source;
...
void BKP_RTC_ClearFlagStatus(uint32_t BKP_RTC_FLAG)
{
    ...
    tmpreg = ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS & (~((uint32_t)0x00000007));
    tmpreg |= BKP_RTC_FLAG;

    ((MDR_BKP_TypeDef *) (0x400D8000))->RTC_CS = tmpreg;
}
...
# 452 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
void BKP_EnterSTOPMode(FunctionalState BKP_Regulator_state, BKP_Stop_Entry_Mode BKP_STOPentry)
{
...
# 554 "SPL/MDR32Fx/src/MDR32F9Qx_bkp.c"
void BKP_EnterSTANDBYMode(void)
{
