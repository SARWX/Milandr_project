# 1 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h" 2
# 51 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef enum
{
    COMP_PlusInput_IN1 = (((uint32_t)0x0) << 8),
    COMP_PlusInput_CVREF = (((uint32_t)0x1) << 8)
} COMP_Plus_Inp_Src;
...
typedef enum
{
    COMP_MinusInput_IN2 = (((uint32_t)0x0) << 9),
    COMP_MinusInput_IN1 = (((uint32_t)0x1) << 9),
    COMP_MinusInput_IN3 = (((uint32_t)0x2) << 9),
    COMP_MinusInput_IVREF = (((uint32_t)0x3) << 9)
} COMP_Minus_Inp_Src;
# 79 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef enum
{
    COMP_OUT_INV_Disable = (((uint32_t)0x0) << 11),
    COMP_OUT_INV_Enable = (((uint32_t)0x1) << 11)
} COMP_Out_Inv_State;
...
typedef enum
{
    COMP_CVREF_SOURCE_AVdd = (((uint32_t)0x0) << 2),
    COMP_CVREF_SOURCE_VRef = (((uint32_t)0x1) << 2)
} COMP_CVRef_Src;
# 105 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef enum
{
    COMP_CVREF_RANGE_Up = (((uint32_t)0x0) << 1),
    COMP_CVREF_RANGE_Dn = (((uint32_t)0x1) << 1)
} COMP_CVRef_Range;
# 118 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef enum
{
    COMP_CVREF_SCALE_0_div_24 = (((uint32_t)0x0) << 4),
    COMP_CVREF_SCALE_1_div_24 = (((uint32_t)0x1) << 4),
    COMP_CVREF_SCALE_2_div_24 = (((uint32_t)0x2) << 4),
    COMP_CVREF_SCALE_3_div_24 = (((uint32_t)0x3) << 4),
    COMP_CVREF_SCALE_4_div_24 = (((uint32_t)0x4) << 4),
    COMP_CVREF_SCALE_5_div_24 = (((uint32_t)0x5) << 4),
    COMP_CVREF_SCALE_6_div_24 = (((uint32_t)0x6) << 4),
    COMP_CVREF_SCALE_7_div_24 = (((uint32_t)0x7) << 4),
    COMP_CVREF_SCALE_8_div_24 = (((uint32_t)0x8) << 4),
    COMP_CVREF_SCALE_9_div_24 = (((uint32_t)0x9) << 4),
    COMP_CVREF_SCALE_10_div_24 = (((uint32_t)0xA) << 4),
    COMP_CVREF_SCALE_11_div_24 = (((uint32_t)0xB) << 4),
    COMP_CVREF_SCALE_12_div_24 = (((uint32_t)0xC) << 4),
    COMP_CVREF_SCALE_13_div_24 = (((uint32_t)0xD) << 4),
    COMP_CVREF_SCALE_14_div_24 = (((uint32_t)0xE) << 4),
    COMP_CVREF_SCALE_15_div_24 = (((uint32_t)0xF) << 4),



    COMP_CVREF_SCALE_8_div_32 = (((uint32_t)0x0) << 4),
    COMP_CVREF_SCALE_9_div_32 = (((uint32_t)0x1) << 4),
    COMP_CVREF_SCALE_10_div_32 = (((uint32_t)0x2) << 4),
    COMP_CVREF_SCALE_11_div_32 = (((uint32_t)0x3) << 4),
    COMP_CVREF_SCALE_12_div_32 = (((uint32_t)0x4) << 4),
    COMP_CVREF_SCALE_13_div_32 = (((uint32_t)0x5) << 4),
    COMP_CVREF_SCALE_14_div_32 = (((uint32_t)0x6) << 4),
    COMP_CVREF_SCALE_15_div_32 = (((uint32_t)0x7) << 4),
    COMP_CVREF_SCALE_16_div_32 = (((uint32_t)0x8) << 4),
    COMP_CVREF_SCALE_17_div_32 = (((uint32_t)0x9) << 4),
    COMP_CVREF_SCALE_18_div_32 = (((uint32_t)0xA) << 4),
    COMP_CVREF_SCALE_19_div_32 = (((uint32_t)0xB) << 4),
    COMP_CVREF_SCALE_20_div_32 = (((uint32_t)0xC) << 4),
    COMP_CVREF_SCALE_21_div_32 = (((uint32_t)0xD) << 4),
    COMP_CVREF_SCALE_22_div_32 = (((uint32_t)0xE) << 4),
    COMP_CVREF_SCALE_23_div_32 = (((uint32_t)0xF) << 4)
# 173 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
} COMP_CVRef_Scale;
# 211 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef enum
{
    COMP_CFG_FLAG_READY = (((uint32_t)0x1) << 12),
    COMP_CFG_FLAG_IE = (((uint32_t)0x1) << 13)
} COMP_CFG_Flags;
...
typedef enum
{
    COMP_STATUS_FLAG_SY = (((uint32_t)0x1) << 0),
    COMP_STATUS_FLAG_AS = (((uint32_t)0x1) << 1),
    COMP_STATUS_FLAG_LCH = (((uint32_t)0x1) << 2)
} COMP_STATUS_Flags;
# 237 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
typedef struct
{
    COMP_Plus_Inp_Src COMP_PlusInputSource;

    COMP_Minus_Inp_Src COMP_MinusInputSource;

    COMP_Out_Inv_State COMP_OutInversion;
...
typedef struct
{
    COMP_CVRef_Src COMP_CVRefSource;



    COMP_CVRef_Range COMP_CVRefRange;


    COMP_CVRef_Scale COMP_CVRefScale;

} COMP_CVRefInitTypeDef;
# 287 "./SPL/MDR32Fx/inc\\MDR32F9Qx_comp.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c" 2
# 44 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
void COMP_DeInit(void)
{
    ((MDR_COMP_TypeDef *) (0x40098000))->CFG = 0;
    ((MDR_COMP_TypeDef *) (0x40098000))->RESULT_LATCH;
}
# 57 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
void COMP_Init(const COMP_InitTypeDef* COMP_InitStruct)
{
    uint32_t tmpreg_CFG;
...
# 206 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
void COMP_CVRefInit(const COMP_CVRefInitTypeDef* COMP_CVRefInitStruct)
{
    uint32_t tmpreg_CFG;
...
# 357 "SPL/MDR32Fx/src/MDR32F9Qx_comp.c"
void COMP_CVRefScaleConfig(COMP_CVRef_Scale Scale)
{
    uint32_t tmpreg_CFG;
