# 1 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_power.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h" 2
# 52 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    POWER_DUcc_upto_10MHz = ((uint32_t)((0 << 3)|(0))),
    POWER_DUcc_upto_200kHz = ((uint32_t)((1 << 3)|(1))),
    POWER_DUcc_upto_500kHz = ((uint32_t)((2 << 3)|(2))),
    POWER_DUcc_upto_1MHz = ((uint32_t)((3 << 3)|(3))),
    POWER_DUcc_clk_off = ((uint32_t)((4 << 3)|(4))),
    POWER_DUcc_upto_40MHz = ((uint32_t)((5 << 3)|(5))),
    POWER_DUcc_upto_80MHz = ((uint32_t)((6 << 3)|(6))),
    POWER_DUcc_over_80MHz = ((uint32_t)((7 << 3)|(7)))
} PWR_DUcc_Mode;
# 76 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    POWER_DUcc_plus_100mV = ((uint32_t)(0x0000 << 8)),
    POWER_DUcc_plus_060mV = ((uint32_t)(0x0001 << 8)),
    POWER_DUcc_plus_040mV = ((uint32_t)(0x0002 << 8)),
    POWER_DUcc_plus_010mV = ((uint32_t)(0x0003 << 8)),
    POWER_DUcc_minus_010mV = ((uint32_t)(0x0004 << 8)),
    POWER_DUcc_minus_040mV = ((uint32_t)(0x0005 << 8)),
    POWER_DUcc_minus_060mV = ((uint32_t)(0x0006 << 8)),
    POWER_DUcc_minus_100mV = ((uint32_t)(0x0007 << 8))
} PWR_DUcc_Trim;
# 102 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    PWR_PVDlevel_2V0 = ((uint32_t)(0x00 << 3)),
    PWR_PVDlevel_2V2 = ((uint32_t)(0x01 << 3)),
    PWR_PVDlevel_2V4 = ((uint32_t)(0x02 << 3)),
    PWR_PVDlevel_2V6 = ((uint32_t)(0x03 << 3)),
    PWR_PVDlevel_2V8 = ((uint32_t)(0x04 << 3)),
    PWR_PVDlevel_3V0 = ((uint32_t)(0x05 << 3)),
    PWR_PVDlevel_3V2 = ((uint32_t)(0x06 << 3)),
    PWR_PVDlevel_3V4 = ((uint32_t)(0x07 << 3))
} PWR_Voltage_Detector_Lvl;
# 126 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    PWR_PVBDlevel_1V8 = ((uint32_t)(0x00 << 1)),
    PWR_PVBDlevel_2V2 = ((uint32_t)(0x01 << 1)),
    PWR_PVBDlevel_2V6 = ((uint32_t)(0x02 << 1)),
    PWR_PVBDlevel_3V0 = ((uint32_t)(0x03 << 1))
} PWR_Batt_Voltage_Detector_Lvl;
# 142 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    POWER_FLAG_PVD = ((uint32_t)((uint32_t)0x00000080)),
    POWER_FLAG_PVBD = ((uint32_t)((uint32_t)0x00000040))
} PWR_Voltage_Detector_Flags;
# 157 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    POWER_PVD_IT = ((uint32_t)((uint32_t)0x00000200)),
    POWER_PVBD_IT = ((uint32_t)((uint32_t)0x00000100))
...
typedef enum
{
    POWER_PVD_INV = ((uint32_t)((uint32_t)0x00000800)),
    POWER_PVBD_INV = ((uint32_t)((uint32_t)0x00000400))
} PWR_Voltage_Detector_IT_Inversion;
# 200 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
typedef enum
{
    POWER_STOPentry_WFE = ((uint32_t)0x00),
    POWER_STOPentry_WFI = ((uint32_t)0x01)
} PWR_Stop_Entry_Mode;
# 220 "./SPL/MDR32Fx/inc\\MDR32F9Qx_power.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_power.c" 2
# 74 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
void POWER_DeInit(void)
{
...
void POWER_DUccMode(PWR_DUcc_Mode DUccMode)
{
    ...
    tmpreg |= ((uint32_t)(((uint32_t)0x00000007) | ((uint32_t)0x00000038))) & ((uint32_t)DUccMode);
...
void POWER_DUccTrim(PWR_DUcc_Trim DUccTrim)
{
    ...
    tmpreg |= ((uint32_t)((uint32_t)0x00000700)) & ((uint32_t)DUccTrim);
...
# 208 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
void POWER_EnterSTOPMode(FunctionalState POWER_Regulator_state, PWR_Stop_Entry_Mode POWER_STOPentry)
{
...
# 286 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
void POWER_PVDenable(FunctionalState NewState)
{
...
# 304 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
}
...
void POWER_PVDlevelConfig(PWR_Voltage_Detector_Lvl POWER_PVDlevel)
{
    ...
    tmpreg |= ((uint32_t)POWER_PVDlevel & ((uint32_t)0x00000038));
...
void POWER_PVBDlevelConfig(PWR_Batt_Voltage_Detector_Lvl POWER_PVBDlevel)
{
    ...
    tmpreg |= ((uint32_t)POWER_PVBDlevel & ((uint32_t)0x00000006));
...
FlagStatus POWER_GetFlagStatus(PWR_Voltage_Detector_Flags POWER_FLAG)
{
    ...
    if ((((MDR_POWER_TypeDef *) (0x40058000))->PVDCS & (uint32_t)POWER_FLAG) != (uint32_t)RESET)
    {
        status = SET;
    }
    else
...
# 399 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
void POWER_PVD_ITconfig(uint32_t POWER_IT, FunctionalState NewState)
{
...
# 422 "SPL/MDR32Fx/src/MDR32F9Qx_power.c"
void POWER_PVD_INVconfig(uint32_t POWER_INV, FunctionalState NewState)
{
