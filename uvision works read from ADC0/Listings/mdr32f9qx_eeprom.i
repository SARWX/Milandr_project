# 1 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h" 2
# 49 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h"
typedef enum
{
...
# 68 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h"
typedef enum
{
...
# 131 "./SPL/MDR32Fx/inc\\MDR32F9Qx_eeprom.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c" 2
# 63 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          static void ProgramDelay(uint32_t Loops) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));


          static inline void EEPROM_UpdateDCacheC(void) __attribute__((section("EXECUTABLE_MEMORY_SECTION")));
# 83 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
...
# 128 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
void EEPROM_SetLatency(EEPROM_Latency_Cycles EEPROM_Latency)
{
...
EEPROM_Latency_Cycles EEPROM_GetLatency(void)
{
    ...
    return (EEPROM_Latency_Cycles)((((MDR_EEPROM_TypeDef *) (0x40018000))->CMD & ((uint32_t)0x38)) >> 3);
}
# 159 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          uint8_t EEPROM_ReadByte(uint32_t Address, EEPROM_Mem_Bank BankSelector)
{
    uint32_t Data;
    uint32_t Command;
    uint32_t Shift;
    ...
    Command |= (BankSelector == EEPROM_Info_Bank_Select) ? ((uint32_t)0x00000200) : 0;
...
# 197 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          uint16_t EEPROM_ReadHalfWord(uint32_t Address, EEPROM_Mem_Bank BankSelector)
{
    uint32_t Data;
    uint32_t Command;
    uint32_t Shift;
...
# 235 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          uint32_t EEPROM_ReadWord(uint32_t Address, EEPROM_Mem_Bank BankSelector)
{
    uint32_t Command;
    uint32_t Data;
...
# 269 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_ErasePage(uint32_t Address, EEPROM_Mem_Bank BankSelector)
{
    uint32_t Command;
    uint32_t Offset;
    ...
    for (Offset = 0; Offset < (4 << 2); Offset += 4)
    {
        ...
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(5) * (16.0) / (8UL))));
        Command |= ((uint32_t)0x00002000);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(40000) * (16.0) / (8UL))));
        Command &= ~((uint32_t)0x00000400);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(5) * (16.0) / (8UL))));
        Command &= ~(((uint32_t)0x00000040) | ((uint32_t)0x00002000));
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(1) * (16.0) / (8UL))));
    }
    ...
    ProgramDelay(((uint32_t)((double)(4000) * (16.0) / (8UL))));
}
# 315 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_EraseAllPages(EEPROM_Mem_Bank BankSelector)
{
    ...
    ((MDR_EEPROM_TypeDef *) (0x40018000))->KEY = ((uint32_t)0x8AAA5551);
    Command = (((MDR_EEPROM_TypeDef *) (0x40018000))->CMD & ((uint32_t)0x00000038)) | ((uint32_t)0x00000001);
    Command |= (BankSelector == EEPROM_All_Banks_Select) ? ((uint32_t)0x00000200) : 0;
    ...
    for (Offset = 0; Offset < (4 << 2); Offset += 4)
    {
        ...
        Command &= ~((uint32_t)0x00000400);
        ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
        ProgramDelay(((uint32_t)((double)(100) * (16.0) / (8UL))));
...
# 364 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_ProgramByte(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data)
{
    uint32_t Mask;
    uint32_t Tmp;
    uint32_t Shift;
...
# 392 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_ProgramHalfWord(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data)
{
    uint32_t Mask;
    uint32_t Tmp;
    uint32_t Shift;
...
# 420 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_ProgramWord(uint32_t Address, EEPROM_Mem_Bank BankSelector, uint32_t Data)
{
    uint32_t Command;
    ...
    Command |= ((uint32_t)0x00002000);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((double)(10) * (16.0) / (8UL))));
    Command |= ((uint32_t)0x00000080);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
    ProgramDelay(((uint32_t)((double)(40) * (16.0) / (8UL))));
    Command &= ~((uint32_t)0x00000080);
    ((MDR_EEPROM_TypeDef *) (0x40018000))->CMD = Command;
...
# 463 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          void EEPROM_UpdateDCache(void)
{
...
# 479 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
          static inline void EEPROM_UpdateDCacheC(void)
{
    volatile uint32_t i, tmp;
    volatile uint32_t *ptr_eeprom = (uint32_t *) (((uint32_t)0x08000000));
# 494 "SPL/MDR32Fx/src/MDR32F9Qx_eeprom.c"
    i = 5;
