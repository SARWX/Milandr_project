...
# 4 "./CustomLibs/inc\\SysCLK_for_proj.h" 2

void Setup_CPU_Clock(void);
void delayTick(uint32_t count);
# 2 "CustomLibs/src/SysCLK_for_proj.c" 2
...
# 3 "CustomLibs/src/SysCLK_for_proj.c" 2
# 1 "./CustomLibs/inc\\defines_for_proj.h" 1
# 4 "CustomLibs/src/SysCLK_for_proj.c" 2
...
# 5 "CustomLibs/src/SysCLK_for_proj.c" 2
