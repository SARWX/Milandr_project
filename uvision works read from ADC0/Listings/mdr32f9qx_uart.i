# 1 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h" 2
# 51 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
    BaudRateInvalid = 0,
...
# 77 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 107 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 140 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 167 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 185 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 201 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 235 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef enum
{
...
# 255 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
typedef struct
{
...
# 317 "./SPL/MDR32Fx/inc\\MDR32F9Qx_uart.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c" 2
...
# 25 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c" 2
# 100 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_DeInit(MDR_UART_TypeDef* UARTx)
{
...
# 134 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
BaudRateStatus UART_Init(MDR_UART_TypeDef* UARTx, UART_InitTypeDef* UART_InitStruct)
...
# 188 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
...
# 263 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_Cmd(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
...
# 293 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_ITConfig(MDR_UART_TypeDef* UARTx, uint32_t UART_IT, FunctionalState NewState)
{
...
# 320 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
ITStatus UART_GetITStatus(MDR_UART_TypeDef* UARTx, UART_IT_TypeDef UART_IT)
{
    ITStatus bitstatus;
...
# 350 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
ITStatus UART_GetITStatusMasked(MDR_UART_TypeDef* UARTx, UART_IT_TypeDef UART_IT)
{
    ITStatus bitstatus;
...
# 381 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_ClearITPendingBit(MDR_UART_TypeDef* UARTx, uint32_t UART_IT)
{
...
# 401 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_DMAConfig(MDR_UART_TypeDef* UARTx, UART_IT_FIFO_TypeDef UART_IT_RB_LVL, UART_IT_FIFO_TypeDef UART_IT_TB_LVL)
{
...
# 423 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_DMACmd(MDR_UART_TypeDef* UARTx, uint32_t UART_DMAReq, FunctionalState NewState)
{
...
# 454 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_SendData(MDR_UART_TypeDef* UARTx, uint8_t Data)
{
...
# 470 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
uint16_t UART_ReceiveData(MDR_UART_TypeDef* UARTx)
{
...
# 489 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_BreakLine(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
...
# 517 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_IrDAConfig(MDR_UART_TypeDef* UARTx, UART_IrDA_Mode_TypeDef UART_IrDAMode)
{
    uint32_t cpuclock;
    RST_CLK_FreqTypeDef RST_CLK_Clocks;
...
# 547 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_IrDACmd(MDR_UART_TypeDef* UARTx, FunctionalState NewState)
{
...
# 575 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
FlagStatus UART_GetFlagStatus(MDR_UART_TypeDef* UARTx, UART_Flags_TypeDef UART_FLAG)
{
...
# 606 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
void UART_BRGInit(MDR_UART_TypeDef* UARTx, UART_Clock_BRG_TypeDef UART_BRG)
{
    uint32_t tmpreg;
...
# 662 "SPL/MDR32Fx/src/MDR32F9Qx_uart.c"
