# 1 "SPL/MDR32Fx/src/MDR32F9Qx_wwdg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_wwdg.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_wwdg.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_wwdg.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_wwdg.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_wwdg.h" 2
# 49 "./SPL/MDR32Fx/inc\\MDR32F9Qx_wwdg.h"
typedef enum
{
    WWDG_Prescaler_1 = ((uint32_t)0x0000),
    WWDG_Prescaler_2 = ((uint32_t)0x0080),
    WWDG_Prescaler_4 = ((uint32_t)0x0100),
    WWDG_Prescaler_8 = ((uint32_t)0x0180)
} WWDG_Prescaler;
# 88 "./SPL/MDR32Fx/inc\\MDR32F9Qx_wwdg.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_wwdg.c" 2
# 71 "SPL/MDR32Fx/src/MDR32F9Qx_wwdg.c"
void WWDG_DeInit(void)
{
    ((MDR_WWDG_TypeDef *) (0x40060000))->CR = 0;
    ((MDR_WWDG_TypeDef *) (0x40060000))->CFR = 0;
    ((MDR_WWDG_TypeDef *) (0x40060000))->SR = 0;
}
...
WWDG_Prescaler WWDG_GetPrescaler(void)
{
    return (WWDG_Prescaler)(((MDR_WWDG_TypeDef *) (0x40060000))->CFR & ~((uint32_t)0xFFFFFE7F));
}
...
uint32_t WWDG_GetWindowValue(void)
{
    return (((MDR_WWDG_TypeDef *) (0x40060000))->CFR & ((uint32_t)0x7F));
}
...
uint32_t WWDG_GetCounter(void)
{
    return (((MDR_WWDG_TypeDef *) (0x40060000))->CR & ((uint32_t)0x7F));
}
