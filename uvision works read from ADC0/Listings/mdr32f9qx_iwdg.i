# 1 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
# 1 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h" 1
# 32 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h"
...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h" 2
# 49 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h"
typedef enum
{
...
# 71 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h"
typedef enum
{
    IWDG_FLAG_PVU = ((uint32_t)0x00000001),
    IWDG_FLAG_RVU = ((uint32_t)0x00000002)
} IWDG_Flags;
# 101 "./SPL/MDR32Fx/inc\\MDR32F9Qx_iwdg.h"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c" 2
# 56 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
void IWDG_WriteAccessEnable(void)
{
...
# 78 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
void IWDG_SetPrescaler(IWDG_Prescaler IWDG_Prescaler_Value)
{

    ((void)0U);

    ((MDR_IWDG_TypeDef *) (0x40068000))->PR = IWDG_Prescaler_Value;
}
...
IWDG_Prescaler IWDG_GetPrescaler(void)
{
    return (IWDG_Prescaler)(((MDR_IWDG_TypeDef *) (0x40068000))->PR);
}
# 104 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
void IWDG_SetReload(uint32_t Reload)
{
...
# 119 "SPL/MDR32Fx/src/MDR32F9Qx_iwdg.c"
uint32_t IWDG_GetReload(void)
{
    return (((MDR_IWDG_TypeDef *) (0x40068000))->RLR & 0x0FFF);
}
