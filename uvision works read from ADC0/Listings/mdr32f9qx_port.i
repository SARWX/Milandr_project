# 1 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 383 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "SPL/MDR32Fx/src/MDR32F9Qx_port.c" 2
# 23 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
...
# 24 "SPL/MDR32Fx/src/MDR32F9Qx_port.c" 2
# 69 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_DeInit(MDR_PORT_TypeDef* MDR_PORTx)
{
...
# 95 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_Init(MDR_PORT_TypeDef* MDR_PORTx, const PORT_InitTypeDef* PORT_InitStruct)
{
    uint32_t tmpreg_OE;
    ...
    MDR_PORTx->OE = tmpreg_OE & (~0);
    MDR_PORTx->FUNC = tmpreg_FUNC & (~0);
    MDR_PORTx->ANALOG = tmpreg_ANALOG & (~0);
    MDR_PORTx->PULL = tmpreg_PULL & (~0);
    MDR_PORTx->PD = tmpreg_PD & (~0);
    MDR_PORTx->PWR = tmpreg_PWR & (~0);
    MDR_PORTx->GFEN = tmpreg_GFEN & (~0);
# 173 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
}
...
# 205 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
uint8_t PORT_ReadInputDataBit(MDR_PORT_TypeDef* MDR_PORTx, PORT_Pin_TypeDef PORT_Pin)
{
    uint8_t bitstatus;
...
# 232 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
uint32_t PORT_ReadInputData(MDR_PORT_TypeDef* MDR_PORTx)
{
...
# 249 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_SetBits(MDR_PORT_TypeDef* MDR_PORTx, uint32_t PORT_Pin)
{
    ...
    MDR_PORTx->RXTX = (PORT_Pin | MDR_PORTx->RXTX) & (~0);
...
# 274 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_ResetBits(MDR_PORT_TypeDef* MDR_PORTx, uint32_t PORT_Pin)
{
...
# 304 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_WriteBit(MDR_PORT_TypeDef* MDR_PORTx, uint32_t PORT_Pin, BitAction BitVal)
...
# 350 "SPL/MDR32Fx/src/MDR32F9Qx_port.c"
void PORT_Write(MDR_PORT_TypeDef* MDR_PORTx, uint32_t PortVal)
{
